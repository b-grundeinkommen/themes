  ...
  <div class="row">
	...
	<?php
	    ...
	    if (($options['aktiv-platzhalterbilder-indexseiten']==1) && (isset($options['src-default-symbolbild-author']))) {  
			...
			$attribs = BGE_kleider_get_image_attributs($options['src-default-symbolbild-author_id']);
		    } else {
		...
		?>    		    		    		        
		   <h1 class="post-title"><span><?php printf( __( '%s', 'BGE_kleider' ), get_the_author() ); ?></span></h1>
	  ...
	  <?php if (!(isset($image_url) && (strlen($image_url)>4))) { ?>
	    <h1 class="post-title"><span itemprop="name"><?php printf( __( '%s', 'BGE_kleider' ), get_the_author() ); ?></span></h1>
	<?php }  
