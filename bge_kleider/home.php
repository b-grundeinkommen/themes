...
<div class="section content" id="main-content">
  <div class="row">
    <div class="content-primary" role="main">
	  ...
	  if (($options['artikelstream-nextnum-main']>0) && ($i>$options['artikelstream-maxnum-main'])) {	      
	    ...
	    if (( isset($options['artikelstream-numfullwidth-main']))
		  ...
		  $output = BGE_kleider_post_teaser($options['teaser-titleup'],$options['teaser-datebox'],$options['teaser-dateline'],$options['teaser_maxlength'],$options['teaser-thumbnail_fallback'],$options['teaser-floating']);
	    } else {
		  $output =BGE_kleider_post_teaser($options['teaser-titleup-halfwidth'],$options['teaser-datebox-halfwidth'],$options['teaser-dateline-halfwidth'],$options['teaser-maxlength-halfwidth'],$options['teaser-thumbnail_fallback'],$options['teaser-floating-halfwidth']);
	    }
	    if (isset($output)) {
	      $cols[$col++] = $output;
	    }
	...
	if ($foundarticles==0) { ?>
            ...
            <p>
            <?php _e("Did not found any article. Please try to search:", 'BGE_kleider'); ?>
            </p>
            <?php get_search_form(); 
            echo "<hr>\n"; 
