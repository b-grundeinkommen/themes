...
<ul>   
    ...
    <li><a class="extern" href="http://wiki.bgepartei.de/BGE_Design/Aktuell#Schriften">Schrift PoliticsHead</a> (<span lang="en">WTFPL License</span> 1.1)</li>
    ...
    <li><a class="extern" href="http://wiki.bgepartei.de/Grafiken">Wallpaper und Bildmaterial der bgepartei Deutschland</a> 
...
<h3>Credits</h3>
    <p>
        Das Wordpress-Theme <a class="extern" href="http://www.BGE_kleider.de">BGE_kleider</a> wurde entwickelt von:     
    </p>
    <ul>
