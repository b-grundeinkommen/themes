...
<?php
	...
	$subtitle =  $options['teaser-subtitle'];
        ...
        <div class="flexslider">
            <h2 class="skip"><?php _e( 'Information slides', 'BGE_kleider' ); ?></h2>
            <ul class="slides">
        <?php 
        if ( have_posts() ) while ( have_posts() ) : the_post();
			...
			if (isset($options['slider-defaultbildsrc_id'])) {
			    ...
			    $image_url = $image_url_data[0];
			    $attribs = BGE_kleider_get_image_attributs($options['slider-defaultbildsrc_id']);
			} else {
		   ...
		   if (isset($options['slider-defaultbildsrc_id']) && ($options['slider-defaultbildsrc_id']>0)) {
                ...
                echo get_BGE_kleider_custom_excerpt();
                echo "</div></div>";          
            }
