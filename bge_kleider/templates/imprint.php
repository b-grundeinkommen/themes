...
<div class="section content" id="main-content">
  <div class="row">
	...
	<?php } ?>
          ...
          <p>
             <?php _e('This website is brought to you by:','BGE_kleider'); ?>
          ...
          <p><?php _e('Responsible for this website:','BGE_kleider'); ?> 
           ...
           <?php } ?>
            ...
            <h2><?php _e('Postal address','BGE_kleider'); ?></h2>
            <address>
           ...
           <?php } ?>
            ...
            <h2><?php _e('Digital contact','BGE_kleider'); ?></h2>   
            <ul>
          ...
          <?php } else { ?>
           ...
           <?php if ((isset($options['ladungtitel'])) && (strlen(trim($options['ladungtitel']))>1)
            ...
            <h2><?php _e('Postal address for matters in law','BGE_kleider'); ?></h2>
             <address>
                 <?php 
...
<ul>   
    ...
    <li><a class="extern" href="http://wiki.bgepartei.de/BGE_Design/Aktuell#Schriften">Font PoliticsHead</a> (<span lang="en">WTFPL Licence</span>)</li>
    ...
    <li><a class="extern" href="http://wiki.bgepartei.de/Grafiken">Wallpaper and Images by BGE Party Germany</a></li>    
    ...
    <div class="content-aside">
      <div class="skin">
        <h1 class="skip"><?php _e( 'More information', 'BGE_kleider' ); ?></h1>           
         <?php  
            get_BGE_kleider_seitenmenu($options['zeige_sidebarpagemenu'],$options['zeige_subpagesonly'],$options['seitenmenu_mode']);
            get_sidebar(); 
          ?>
      </div>
    </div>
