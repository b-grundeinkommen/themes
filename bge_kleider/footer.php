...
<div class="section footer">
    ...
    <nav role="navigation">
		...
		<li><a class="p3-skip" id="skiplink-top" href="#top"><?php _e( 'Back to top.', 'BGE_kleider' ); ?></a></li>
		<li><a class="p3-skip" id="skiplink-content-bottom" href="#main-content"><?php _e( 'Back to start of content.', 'BGE_kleider' ); ?></a></li>
		<?php if ( $options['aktiv-suche'] == "1" ){ ?>
                <li><a class="p3-skip" id="skiplink-search-bottom" href="#searchform"><?php _e( 'Back to search form.', 'BGE_kleider' ); ?></a></li>
		<?php } ?>
	</ul>
    </nav>
  </div>
	...
	jQuery(document).ready(function($) {
	 ...
	 $('.flexslider').flexslider({
	    ...
	    touch: true,
            directionNav: false,
            controlNav: true,     
            pauseText: "<?php _e('Stop','BGE_kleider'); ?>",
            playText: "<?php _e('Start','BGE_kleider'); ?>",            
           });	   
         <?php } 
         if ($options['slider-defaultwerbeplakate']==1) { ?>
          ...
          if (breite > 600) {        
             $('.slidersidebar').flexslider({
                ...
                directionNav: true,
                controlNav: false,
                nextText: "<?php _e('Next','BGE_kleider'); ?>",
                prevText: "<?php _e('Back','BGE_kleider'); ?>",
                pauseText: "<?php _e('Stop','BGE_kleider'); ?>",
                playText: "<?php _e('Start','BGE_kleider'); ?>",
               });
           }
